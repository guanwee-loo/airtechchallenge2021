...
The data are preloaded into Neo4j DB using Cypher scripts generated by Python3 scripts found in the batch directory. The input of the Python3 script is the SIDS/STARS information of an airport in JSON format.

Getting the Top N results is simply executing a Cypher query:
